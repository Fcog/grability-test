...
<application> element:
    ...
    */
    ...
    public static final String AUTHORITY = "com.franciscogiraldo.fcog.grability.db.provider";
    ...
    private static final String TABLENAME = AppDao.TABLENAME;
    private static final String PK = AppDao.Properties.Id
    .columnName;

    private static final int APP_DIR = 0;
    ...
    sURIMatcher.addURI(AUTHORITY, BASE_PATH, APP_DIR);
